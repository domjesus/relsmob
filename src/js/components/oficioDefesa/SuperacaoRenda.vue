<template>
  ...
  <ol contenteditable>
    ...
    <li>Advertimos quanto à necessidade de manter o Cadastro Único atualizado, requisito para manutenção do benefício objeto desta apuração, conforme disposto nos artigos 12 e 13 do Decreto n.º 6214/07.</li>
