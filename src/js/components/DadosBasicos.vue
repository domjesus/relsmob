<template>
  <div class="ml-5 pr-5 mr-5">
    ...
    A renda que o(a) Sr(a) {{
          membroIrregularidade.trim().toUpperCase()
        }} recebe {{
          hasRecebeValor
...
export default {
  ...
  computed: {
    ...
    hasRecebeValor() {
      const valor = parseFloat(this.vlrIrregularidade.split(" ")[1]);
      // console.log(valor);
      if (valor) return `no valor de ${this.vlrIrregularidade}`;
    },
  },
  methods: {
    ...mapActions([
